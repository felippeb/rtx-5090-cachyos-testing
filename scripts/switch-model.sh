...
print_usage() {
    ...
    echo ""
    echo "Examples:"
    echo "  $0 nvfp4-196k     Start daily driver (Qwen3.8-27B NVFP4-MTP, 196K)"
    echo "  $0 nvfp4          Start 131K variant (bf16 KV cache)"
    echo "  $0 qwen36         Start previous daily driver (Qwen3.6-27B NVFP4-MTP)"
    echo "  $0 nvfp4-long     Start 262K context variant"
    echo "  $0 huihui         Start abliterated variant (Huihui Qwen3.8-27B)"
